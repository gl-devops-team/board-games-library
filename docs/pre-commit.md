...
```git
::error title=ruff (F401),file=/<project_path>/app/src/games/admin.py,line=1,col=28,endLine=1,endColumn=33::app/src/games/admin.py:1:28: F401 `django.contrib.admin` imported but unused
::error title=ruff (I001),file=/<project_path>/app/src/games/urls.py,line=2,endLine=3::app/src/games/urls.py:2:1: I001 Import block is un-sorted or un-formatted
```
